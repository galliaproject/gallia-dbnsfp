...
// ===========================================================================
object DbNsfpDriver extends App {
  ...
  // ===========================================================================
  /** 
    original is at ftp://dbnsfp:dbnsfp@dbnsfp.softgenetics.com/dbNSFP4.0a.zip
    
    example input row (minus Polyphen2, VEST, REVEL, ClinPred, CADD, LINSIGHT, and GenoCanyon for licensing reasons - see https://sites.google.com/site/jpopgen/dbNSFP):
      {{{
  ...
  */
  lazy val InputFile = // TODO: ask if could include small subset here for people who just want to test this out (and avoid unnecessary traffic for their FTP server)
    "/data/dbnsfp/4.0a/dbNSFP4.0a_variant.chr21.1k.gz" // first 1K lines only

  // ===========================================================================
  /**
     example output object (minus Polyphen2, VEST, REVEL, ClinPred, CADD, LINSIGHT, and GenoCanyon for licensing reasons - see https://sites.google.com/site/jpopgen/dbNSFP):
   ...
   */
  lazy val OutputFile = "/tmp/dbnsfp.jsons.gz"
